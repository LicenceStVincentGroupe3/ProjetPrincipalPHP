...
class CompanyTurnover
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Parameter", mappedBy="idCompanyTurnover")
     */
    private $idParameter;
    ...
    public function addIdParameter(Parameter $idParameter): self
    {
        if (!$this->idParameter->contains($idParameter)) {
            ...
            $idParameter->setIdCompanyTurnover($this);
        }
    ...
    public function removeIdParameter(Parameter $idParameter): self
    {
        if ($this->idParameter->contains($idParameter)) {
            ...
            if ($idParameter->getIdCompanyTurnover() === $this) {
                $idParameter->setIdCompanyTurnover(null);
            }
        }
