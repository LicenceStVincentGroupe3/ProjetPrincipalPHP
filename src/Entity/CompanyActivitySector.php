...
class CompanyActivitySector
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Parameter", mappedBy="idCompanyActivitySector")
     */
    private $idParameter;
    ...
    public function addIdParameter(Parameter $idParameter): self
    {
        if (!$this->idParameter->contains($idParameter)) {
            ...
            $idParameter->setIdCompanyActivitySector($this);
        }
    ...
    public function removeIdParameter(Parameter $idParameter): self
    {
        if ($this->idParameter->contains($idParameter)) {
            ...
            if ($idParameter->getIdCompanyActivitySector() === $this) {
                $idParameter->setIdCompanyActivitySector(null);
            }
        }
